...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnWallRunStateChanged);
...
public:
    ...
    UPROPERTY(BlueprintAssignable, Category = "Movement|WallRun")
    FOnWallRunStateChanged OnWallRunStartedDelegate;

    UPROPERTY(BlueprintAssignable, Category = "Movement|WallRun")
    FOnWallRunStateChanged OnWallRunEndedDelegate;
